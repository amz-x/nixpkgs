...
stdenv.mkDerivation (finalAttrs: {
  pname = "gala";
  version = "8.5.1-unstable-2026-09-10"; # nixpkgs-update: no auto update

  src = fetchFromGitHub {
    owner = "elementary";
    repo = "gala";
    rev = "261c8c6121d7d7e3276b6087eb8c5d619f8cb80c";
    hash = "sha256-nuPPknzxXoyszevRZ9UJx7KBNl0EiT8sw0ThJZXQMrQ=";
  };
