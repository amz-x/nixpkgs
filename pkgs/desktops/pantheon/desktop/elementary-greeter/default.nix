...
stdenv.mkDerivation {
  ...
  version = "8.1.2-unstable-2026-09-26"; # nixpkgs-update: no auto update

  src = fetchFromGitHub {
    owner = "elementary";
    repo = "greeter";
    rev = "bc441b64d539c84a53017293006cf0bcdaa44950";
    hash = "sha256-7BbDze4MvtZpyRcdSfuMUhS4/T/V+nHQQlEDfVlpbvY=";
  };
