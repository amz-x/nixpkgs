...
stdenv.mkDerivation {
  pname = "wingpanel";
  version = "8.0.4-unstable-2026-09-19"; # nixpkgs-update: no auto update

  src = fetchFromGitHub {
    owner = "elementary";
    repo = "wingpanel";
    rev = "2259b7ed907efcd86cbb5000c004fd393eef3502";
    hash = "sha256-uj8TrxKHobyjlBETAlMBaA3tn+6mmZgnvbE9CBuLb44=";
  };
