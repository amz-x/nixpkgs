...
stdenv.mkDerivation {
  pname = "wingpanel";
  version = "8.0.4-unstable-2026-09-12"; # nixpkgs-update: no auto update

  src = fetchFromGitHub {
    owner = "elementary";
    repo = "wingpanel";
    rev = "548769ab40b4e7229656eb50780dcb9bd576a6d4";
    hash = "sha256-clfONrPKMYG3Rq26JHK8pDVlAUZy+a5SqzTFY0dK2+8=";
  };
