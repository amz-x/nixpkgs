...
stdenv.mkDerivation {
  pname = "granite";
  version = "7.8.1-unstable-2026-09-25"; # nixpkgs-update: no auto update
  ...
  src = fetchFromGitHub {
    owner = "elementary";
    repo = "granite";
    rev = "ed28abc5d668dfda15b8673418cecc770331247d";
    hash = "sha256-hIiYkyEurIWlFQCOljEi4V1L63DQiXtANlZnAmEvlW4=";
  };
