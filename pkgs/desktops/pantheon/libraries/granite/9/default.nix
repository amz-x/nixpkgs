...
stdenv.mkDerivation {
  pname = "granite";
  version = "7.8.1-unstable-2026-09-14"; # nixpkgs-update: no auto update
  ...
  src = fetchFromGitHub {
    owner = "elementary";
    repo = "granite";
    rev = "9cfbf552e61e9b73f02fa1da9707db13d15108e0";
    hash = "sha256-kgoGwIuc5K1CsQLnV454R96FxEETk9iVYt4+rRiRJP8=";
  };
