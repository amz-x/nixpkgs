...
stdenv.mkDerivation {
  pname = "granite";
  version = "7.8.1-unstable-2026-09-12"; # nixpkgs-update: no auto update
  ...
  src = fetchFromGitHub {
    owner = "elementary";
    repo = "granite";
    rev = "a20c4fd3215e900a2e1496cc3b3cc7bb7915ad39";
    hash = "sha256-R1x4pZYLD2HdorE0EFagNbaawKHAm0j+32Uxt71MfMw=";
  };
